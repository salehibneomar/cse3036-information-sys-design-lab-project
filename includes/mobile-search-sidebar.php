   ...
   <aside class="sidebarBackground"></aside>
            
            <aside class="filterPanel">
                <button class="btn btn-info btn-lg filterAsideCloseBtn d-block w-100"><i class="fas fa-arrow-left"></i></button>
                <form action="" method="get">
                    <div class="card side-content-card">
                        <div class="card-header bg-light">
                            <span class=" text-muted d-block"><small>Search&ensp;<i class="fas fa-search"></i></small></span>
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card side-content-card">
                        <div class="card-header bg-light">
                            <span class=" text-muted d-block"><small>Sort&ensp;<i class="fas fa-sort"></i></small></span>
                        </div>
                        <div class="card-body">
